...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const checkSession = {
                "AuthProvider.useEffect.checkSession": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/auth/session');
    ...
    const login = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/login', {
                email,
                password
            });
            setUser(response.data.user);
            router.push(response.data.role === 'tutor' ? '/dashboard' : '/browse-courses');
        } catch (error) {
    ...
    const signup = async (email, password, role, name)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/signup', {
                email,
                password,
                role,
                name
...
//# sourceMappingURL=src_8e2317f1._.js.map