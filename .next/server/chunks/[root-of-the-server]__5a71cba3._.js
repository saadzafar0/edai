...
async function POST(request) {
    try {
        ...
        const backendRes = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3001") || 'http://localhost:3001'}/auth/signup`, {
            method: 'POST',
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a71cba3._.js.map