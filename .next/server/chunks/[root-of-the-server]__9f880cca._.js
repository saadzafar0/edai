...
async function GET() {
    try {
        ...
        const backendRes = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3001") || 'http://localhost:3001'}/auth/session`, {
            method: 'GET',
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9f880cca._.js.map